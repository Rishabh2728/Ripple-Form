...
export const HeaderNav: React.FC<{
  ...
  return (
    <header className="h-14 border-b border-[#E7E2DE] bg-white px-4 flex items-center justify-between z-30 shrink-0">
      {/* Left section */}
      <div className="flex items-center gap-3 min-w-0">
        <Link
          href="/dashboard"
          className="p-1.5 rounded-lg text-[#6F6A67] hover:text-[#191716] hover:bg-[#F5F2EF] transition-colors"
        ...
        <div className="flex items-center gap-2 min-w-0">
          {editingTitle ? (
            <input
              ...
              className="text-sm font-bold text-[#191716] bg-[#F5F2EF] px-2 py-0.5 rounded border border-[#6E1F2A] focus:outline-none"
            />
          ) : (
            <h2
              onClick={() => setEditingTitle(true)}
              className="text-sm font-bold text-[#191716] truncate max-w-[200px] cursor-pointer hover:text-[#6E1F2A] transition-colors"
          ...
          <div className="flex items-center gap-1.5 text-[11px] font-medium text-[#6F6A67] ml-2">
            {saveStatus === "saving" && (
              <>
            ...
            {saveStatus === "saved" && (
              <>
                ...
                <span className="text-[#2F7D5B]">Saved</span>
              </>
            )}
            {saveStatus === "error" && (
      ...
      {/* Center Tabs */}
      <nav className="hidden lg:flex items-center gap-1 bg-[#F5F2EF] p-1 rounded-xl">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="p-1.5 rounded-lg border border-[#E7E2DE] text-[#6F6A67] hover:text-[#191716] hover:bg-[#F5F2EF] hidden md:flex items-center gap-1 text-xs"
